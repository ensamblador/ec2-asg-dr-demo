...
ec2_type = "t2.micro"
key_name = "ensamblador-isengard-lab"  # Setup key_name for EC2 instance login 
...
class CdkEc2Stack(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, vpc, **kwargs) -> None:
        ...
        my_ip = ec2.Peer.ipv4("186.105.63.191/32")


        # bastion.connections.allow_from_any_ipv4(ec2.Port.tcp(22), "Internet access SSH")

        bastion.connections.allow_from(my_ip, ec2.Port.tcp(22), "Internet access SSH My IP")
        # Create ALB
        ...
        #listener_https = alb.add_listener(
            #"my443", certificates=[elb.ListenerCertificate(chickyshop_certificate)],  
            #open=True, 
            #port=443, 
        ...
        #listener_https.add_targets("addTargetGroup_https",port=80,targets=[self.asg])
